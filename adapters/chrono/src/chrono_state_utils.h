 ...
 * - The core SystemState types are defined in include/seastack/core/system_state.h.
 *********************************************************************/

#ifndef SEASTACK_ADAPTERS_CHRONO_STATE_UTILS_H
#define SEASTACK_ADAPTERS_CHRONO_STATE_UTILS_H
...
#endif  // SEASTACK_ADAPTERS_CHRONO_STATE_UTILS_H
