...
#ifndef SEASTACK_ADAPTERS_CHRONO_SETUP_FROM_YAML_H
#define SEASTACK_ADAPTERS_CHRONO_SETUP_FROM_YAML_H
...
std::unique_ptr<HydroSystem> SetupHydroFromYAML(
    const seastack::hydro::YAMLHydroData& hydro_data,
...
#endif  // SEASTACK_ADAPTERS_CHRONO_SETUP_FROM_YAML_H
