 ...
 * @brief Core backend for the SEA-Stack logging system.
 *
...
#ifndef SEASTACK_INFRA_LOGGER_BACKEND_H
#define SEASTACK_INFRA_LOGGER_BACKEND_H
...
#endif  // SEASTACK_INFRA_LOGGER_BACKEND_H