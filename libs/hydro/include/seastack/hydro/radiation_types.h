...
#ifndef SEASTACK_HYDRO_RADIATION_TYPES_H
#define SEASTACK_HYDRO_RADIATION_TYPES_H
...
struct RadiationKernelProcessing {
    ...
    double taper_start_fraction = 0.8;     ///< Start taper at this fraction [0,1] of RIRF length
    double taper_end_fraction = 1.0;       ///< End taper at this fraction [0,1] of RIRF length
    ...
    /// Returns a recommended preset: Savitzky-Golay smoothing + half-cosine taper.
    /// Use this when you want "smooth RIRF" without tuning individual options.
    static RadiationKernelProcessing DefaultSmoothing() {
        RadiationKernelProcessing opts;
        opts.smoothing_type = "sg";
        opts.smoothing_window = 5;
        opts.taper_enabled = true;
        opts.taper_start_fraction = 0.8;
        opts.taper_end_fraction = 1.0;
        opts.taper_final_amplitude = 0.0;
        return opts;
    }
};
...
#endif  // SEASTACK_HYDRO_RADIATION_TYPES_H
