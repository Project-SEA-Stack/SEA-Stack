 ...
 * and seastack::chrono::ChronoHydroCoupler delegate force computation to HydroForces.
 *********************************************************************/

#ifndef SEASTACK_HYDRO_FORCES_H
#define SEASTACK_HYDRO_FORCES_H
...
private:
    ...
    bool first_evaluation_traced_ = false;
    
    // Reusable buffer for forces to avoid per-timestep allocation
    mutable BodyForces forces_buffer_;
};

}  // namespace seastack::hydro

#endif  // SEASTACK_HYDRO_FORCES_H
