...
#ifndef SEASTACK_HYDRO_FORCE_COMPONENTS_RADIATION_COMPONENT_H
#define SEASTACK_HYDRO_FORCE_COMPONENTS_RADIATION_COMPONENT_H
...
#include <seastack/hydro/radiation/radiation_rirf_processing.h>
#include <Eigen/Dense>
#include <vector>
#include <memory>
...
private:
    ...
    // Reusable buffer for body velocities to avoid per-timestep allocation
    std::vector<std::vector<double>> body_velocities_buffer_;
...
#endif  // SEASTACK_HYDRO_FORCE_COMPONENTS_RADIATION_COMPONENT_H
