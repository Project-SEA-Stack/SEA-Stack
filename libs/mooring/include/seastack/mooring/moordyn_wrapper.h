 ...
 * SEA-Stack only interacts through SystemState and BodyForces.
 *********************************************************************/

#ifndef SEASTACK_MOORING_MOORDYN_WRAPPER_H
#define SEASTACK_MOORING_MOORDYN_WRAPPER_H
...
public:
    ...
    std::vector<seastack::viz::MooringLineVizData> GetLineStates() const;
...
#endif  // SEASTACK_MOORING_MOORDYN_WRAPPER_H
