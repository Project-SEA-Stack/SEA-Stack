...
![Version](https://img.shields.io/badge/version-1.0.0--beta.4-orange)
...
SEA-Stack is under active development. The current release (v1.0.0-beta.4) provides a robust modular core, validated offshore simulation workflows, and a suite of representative demos and test cases. Packages are currently available for Windows and macOS. Linux packaging and CI/CD are planned. Multi-fidelity capabilities and integration with higher-fidelity methods are planned as the platform evolves.
