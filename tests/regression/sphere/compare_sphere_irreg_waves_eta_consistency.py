#!/usr/bin/env python3
"""
SEA-Stack Sphere Irregular Waves Eta Consistency Test Comparison

This script validates that spectrum synthesis and tabulated eta (IRF convolution)
produce identical heave using the standardized comparison template.
...
# Load compare_template before numpy so missing deps exit 77 (CTest skip), not 1 (fail).
