#!/usr/bin/env python3
"""Run a single SEA-Stack simulation from a setup YAML.
...
def main() -> int:
	"""CLI entrypoint: invoke run_seastack.exe with the given setup YAML."""
	p = argparse.ArgumentParser(description="SEA-Stack – Run simulation (no compare)")
	p.add_argument("--exe", required=True, help="Path to run_seastack.exe")
