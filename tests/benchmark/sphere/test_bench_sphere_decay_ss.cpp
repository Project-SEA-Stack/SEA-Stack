/**
 * Benchmark: sphere heave decay with state-space radiation.
 * Direct comparison pair with sphere_decay_conv.
 */
...
int main(int argc, char* argv[]) {
    ...
    seastack::bench::PrintTrialSummary("sphere_decay_ss", settings, trials);
    ...
    seastack::bench::WriteBenchmarkJSON(
        ...
        "sphere_decay_ss", started_at, finished_at, meta, settings, trials);
