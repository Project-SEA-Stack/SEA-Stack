/**
 * Benchmark: sphere in irregular waves with state-space radiation
 * and IRF excitation. Pair with sphere_irreg_conv to quantify SS benefit.
 */
...
int main(int argc, char* argv[]) {
    ...
    settings.radiation_method = "state_space";
    ...
    auto trial_fn = [&]() -> seastack::bench::TrialResult {
        ...
        hydro.SetRadiationMethod(RadiationMethod::kStateSpace);
    ...
    seastack::bench::PrintTrialSummary("sphere_irreg_ss", settings, trials);
    ...
    seastack::bench::WriteBenchmarkJSON(
        ...
        "sphere_irreg_ss", started_at, finished_at, meta, settings, trials);
