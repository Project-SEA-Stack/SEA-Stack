...
/// Shapes that already have opacity < 1 (from model YAML) keep that alpha and
/// diffuse colour, merged onto the painted-metal PBR fields so Chrono VSG's
/// translucent pipeline receives a complete material.
