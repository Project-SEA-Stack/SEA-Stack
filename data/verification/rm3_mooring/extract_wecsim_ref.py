...
plain-text reference files suitable for SEA-Stack verification tests.
...
def extract(wecsim_dir: Path, repo_root: Path):
    ...
    # ── 1. Wave elevation (etaData.mat -> SEA-Stack eta format) ───────────
    ...
    # SEA-Stack eta format: "time : elevation" per line
...
| PTO stiffness    | 0                                               |
| MoorDyn          | 3 lines, 6 segments (anchor–clump + clump–fairlead each); input: data/demos/run_seastack/rm3/assets/mooring/lines_rm3.txt |
